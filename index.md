...
humantime: "09:00 am - 01:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
contact: ["annajiat@gmail.com" , "d.perez-suarez@ucl.ac.uk" or "mihafiz@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
