...
venue: "Instructor Training Online"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Feb 20-23, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "09:00 am - 01:00 pm BST"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Annajiat Alim Rasel", "David Pérez-Suárez", "Md Intekhabul Hafiz"] # boxed, comma-separated list of trainers' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper:     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["annajiat@gmail.com" , "d.perez-suarez@ucl.ac.uk", "mihafiz@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad: https://pad.carpentries.org/2024-02-20-ttt-online-BST            # optional: URL for the workshop Etherpad if there is one
